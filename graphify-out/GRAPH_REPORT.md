...
## Corpus Check
- 8 files · ~586,476 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2378 nodes · 5453 edges · 151 communities (92 shown, 59 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 349 edges (avg confidence: 0.65)
...
### Community 2 - "Tagger/Prompt i18n Helpers"
Cohesion: 0.09
Nodes (56): showToast(), _applyDefaultCheckpointIfEnabled(), loadWorkflowIntoEditor(), t(), _initPlanDropZone(), _loadPlanFromFile(), _loadPlanFromIndexImage(), _loadPlanFromServer() (+48 more)

### Community 3 - "Prompt Tab Frontend"
Cohesion: 0.09
Nodes (56): refreshStylesList(), apiCreatePreset(), apiDeletePreset(), apiUpdatePreset(), attachFile(), chatWithAi(), clearBatchPresets(), clearChat() (+48 more)
...
### Community 5 - "AI Tool Tab Frontend"
Cohesion: 0.09
...
### Community 6 - "GenerateUI Feeder Tab"
Cohesion: 0.09
Nodes (51): comfyUI, _applyGalToWorkflow(), _applyPreset(), _applyToGalNode(), _applyToNode(), _applyToWorkflow(), _deletePreset(), _deselectAll() (+43 more)
...
### Community 9 - "Settings API Routes"
Cohesion: 0.09
...
### Community 10 - "Nodes Tab Frontend"
Cohesion: 0.11
...
### Community 11 - "Index HTML SPA Shell Layout"
Cohesion: 0.05
...
Cohesion: 0.09
Nodes (41): AI_BACKEND_DEFAULT_URLS, AI_LANG_NAMES, applyTheme(), buildThemePanel(), convertApiToUiWorkflow(), createPanel(), fetchGroups(), fetchMetadata() (+33 more)

### Community 15 - "Generate Tab Frontend & Modals"
Cohesion: 0.09
Nodes (39): _applyNamedStyle(), _applyStyleToWorkflow(), _batchGroupState, _batchStyleSelected, _blobToDataUrl(), _buildFolderTree(), _ckptBatch, _ckptState (+31 more)

### Community 16 - "Gallery Service Core"
Cohesion: 0.10
...
### Community 17 - "Tagger API Routes"
Cohesion: 0.14
...
### Community 18 - "Wildcard Service & Routes"
Cohesion: 0.12
...
### Community 19 - "GenerateUI Lab Tab"
Cohesion: 0.14
Nodes (35): _annotatedImageRef(), _applyPlanData(), _buildIndexImageDataUrl(), _buildPlanData(), _buildWorkflowForIteration(), _clearPlan(), COLUMN_KEYS, _defaultValueFor() (+27 more)

### Community 20 - "ComfyUI Client & Editor"
Cohesion: 0.09
...
### Community 22 - "Workflow Tab Frontend & Storage"
Cohesion: 0.15
Nodes (27): readJsonStorage(), badgeHtml(), _buildStructuredSummaryText(), _buildSummarySourceText(), deleteWorkflow(), fetchWorkflows(), filterWorkflows(), getBadgePalette() (+19 more)
...
### Community 25 - "Node Sets Menu UI Components"
Cohesion: 0.14
...
### Community 26 - "App Shell & i18n Init"
Cohesion: 0.13
Nodes (27): applyCustomFont(), applyCustomOverrides(), applyTheme(), BG_PATTERNS, buildLangOptions(), clearCustomOverrides(), COLOR_TARGETS, FONT_OPTIONS (+19 more)
...
### Community 28 - "Workflow API Routes"
Cohesion: 0.15
...
### Community 29 - "Gallery Metadata Store"
Cohesion: 0.13
...
### Community 30 - "Workflow Service Metadata/Import"
Cohesion: 0.13
...
### Community 31 - "Lab Plan Service & Routes"
Cohesion: 0.15
...
### Community 32 - "Skill Service & Routes"
Cohesion: 0.14
...
### Community 33 - "Style Catalog Tab"
Cohesion: 0.18
Nodes (23): selectStyleByName(), _cellLabel(), buildPromptItem(), loadFileIntoMetadataTab(), activateStyleCatalogTab(), API, apiFetch(), copyText() (+15 more)
...
### Community 39 - "Image Prompt Tab"
Cohesion: 0.19
Nodes (22): activateImagePromptTab(), addSelectedToChips(), API, apiFetch(), cleanPromptText(), clearAllChips(), copyFinalPrompt(), createThumbCard() (+14 more)
...
### Community 41 - "Qwen Chat Integration Plan"
Cohesion: 0.12
...
### Community 42 - "Eagle Integration Routes"
Cohesion: 0.14
...
### Community 46 - "DEVLOG Feeder & Gallery Features"
Cohesion: 0.15
...
### Community 47 - "Node Sets Menu Model Fetch"
Cohesion: 0.22
...
### Community 48 - "CLAUDE.md Node Dev Rules"
Cohesion: 0.15
...
### Community 49 - "DEVLOG Subgraph & Advanced Sampling"
Cohesion: 0.12
...
### Community 50 - "DEVLOG LoRA Pane & Batch Tab"
Cohesion: 0.16
...
### Community 53 - "DEVLOG AI Chat & Comic Creator Bridges"
Cohesion: 0.12
...
### Community 57 - "DEVLOG Image Edit Tool Additions"
Cohesion: 0.16
...
### Community 60 - "GenerateUI Lab Tab"
Cohesion: 0.21
Nodes (15): closeModal(), initModal(), openModal(), _flattenFolderTree(), openCatalogCreateModal(), saveCurrentWorkflow(), _applyStyleToText(), _cellHtml() (+7 more)

### Community 62 - "Eagle Integration Routes"
Cohesion: 0.23
...
### Community 63 - "Prompts API Routes/Service"
Cohesion: 0.25
...
### Community 64 - "Workflow Analyzer"
Cohesion: 0.20
...
### Community 66 - "Eagle Integration Routes"
Cohesion: 0.19
...
### Community 67 - "App Shell & i18n Init"
Cohesion: 0.17
...
### Community 68 - "Gallery Service Vault Helpers"
Cohesion: 0.17
...
### Community 69 - "Generate Tab Frontend & Modals"
Cohesion: 0.20
Nodes (8): initGenerateTab(), _loadStyles(), _renderStyleDropdown(), updateStatus(), highlightJSON(), syncJsonHighlight(), syncScroll(), refreshLabLiveDefaults()

### Community 72 - "Gallery Feeder Extension (Frontend)"
Cohesion: 0.36
Nodes (11): beforeRegisterNodeDef(), fetchGroupImages(), getInputWidget(), getOrCreate(), _ns, setWidgetValue(), startLoop(), stopLoop() (+3 more)

### Community 73 - "DEVLOG Prompt Tab & Wildcard Features"
Cohesion: 0.24
...
### Community 74 - "Settings/CivitAI Config Resolution"
Cohesion: 0.22
Nodes (5): Return CivitAI API key. Env var CIVITAI_API_KEY takes priority over…, Settings management service., Merge updates into existing settings., Manages application settings (data/settings.json)., SettingsService

### Community 77 - "Gallery Feeder Node (Backend)"
Cohesion: 0.27
...
### Community 78 - "App Shell & i18n Init"
Cohesion: 0.24
...
### Community 81 - "Node Sets Metadata Extraction"
Cohesion: 0.36
...
### Community 82 - "Node Sets Menu & Sidebar"
Cohesion: 0.24
Nodes (10): _extractAllMetadata(), _extractWorkflowFromEXIF(), _findNull(), _parseFooocusMetadata(), _parseITXtChunk(), _parseSDAParameters(), _parseTEXtChunk(), _readAllPNGTextChunks() (+2 more)

### Community 83 - "Node Sets Prompt Extraction"
Cohesion: 0.33
...
### Community 84 - "Inpaint Basic Workflow"
Cohesion: 0.53
...
### Community 85 - "Gallery Service Background Indexing"
Cohesion: 0.25
...
### Community 86 - "Style Prompt Seed Import Tool"
Cohesion: 0.36
...
### Community 87 - "FireRed 3D Pose Image Edit Workflow"
Cohesion: 0.32
...
### Community 91 - "DEVLOG AI Chat SVG & Help Redesign"
Cohesion: 0.29
...
### Community 92 - "DEVLOG GenerateUI Model Tab Features"
Cohesion: 0.33
...
### Community 93 - "DEVLOG Node Sets & Prompt Preset"
Cohesion: 0.29
...
### Community 94 - "Config & Service Modules"
Cohesion: 0.29
Nodes (4): Resolve workflows dir from settings, falling back to default., _resolve_workflows_dir(), Node metadata and node sets management service., Prompt presets management service.

### Community 95 - "Settings/CivitAI Config Resolution"
Cohesion: 0.33
...
### Community 97 - "Node Sets Menu Model Fetch"
Cohesion: 0.57
...
### Community 98 - "Release & Publish Workflow"
Cohesion: 0.40
...
### Community 99 - "DEVLOG Style Catalog & ImagePrompt"
Cohesion: 0.40
...
### Community 100 - "DEVLOG Gallery/Models Early Features"
Cohesion: 0.40
...
### Community 101 - "DEVLOG Metadata & Sidepanel I Tab"
Cohesion: 0.40
...
### Community 102 - "Prompt Text Node"
Cohesion: 0.33
...
### Community 103 - "PNG Metadata Extractor"
Cohesion: 0.40
...
### Community 104 - "DEVLOG AI Tab & RAW JSON Search"
Cohesion: 0.67
...
### Community 105 - "DEVLOG Wildcard & Impact Pack"
Cohesion: 0.67
Nodes (3): ImpactWildcardEncode Validation Fix, Impact Pack Symlink Integration, Wildcard Support Panel

## Ambiguous Edges - Review These
- `JSON Syntax Highlighting` → `Subgraph Workflow Support & Conversion Fix`  [AMBIGUOUS]
  DEVLOG.md · relation: conceptually_related_to
- `GenerateUI Checkpoint Batch Redesign — Folder Tree + Pause/Resume (v0.3.4)` → `GenerateUI Feeder Subtab + Workflow Analysis Precision Improvement (v0.3.5)`  [AMBIGUOUS]
  DEVLOG.md · relation: conceptually_related_to

## Knowledge Gaps
- **196 isolated node(s):** `META_NODE_TYPES`, `AI_BACKEND_DEFAULT_URLS`, `AI_LANG_NAMES`, `_META_NODE_TYPES`, `MODEL_NODE_MAP` (+191 more)
...
- **What is the exact relationship between `JSON Syntax Highlighting` and `Subgraph Workflow Support & Conversion Fix`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `GenerateUI Checkpoint Batch Redesign — Folder Tree + Pause/Resume (v0.3.4)` and `GenerateUI Feeder Subtab + Workflow Analysis Precision Improvement (v0.3.5)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `showToast()` connect `Tagger/Prompt i18n Helpers` to `Models Tab Frontend`, `Prompt Tab Frontend`, `AI Tool Tab Frontend`, `GenerateUI Feeder Tab`, `Gallery Tab Frontend & Toasts`, `Nodes Tab Frontend`, `Generate Tab Frontend & Modals`, `GenerateUI Lab Tab`, `Workflow Tab Frontend & Storage`, `App Shell & i18n Init`, `Style Catalog Tab`, `Image Prompt Tab`, `Image Edit Background Removal`, `Image Edit Blur Tool (BlurTool.js)`, `GenerateUI Lab Tab`, `Generate Tab Frontend & Modals`, `Image Edit Background Removal (BgRemove.js)`, `App Shell & i18n Init`, `Image Edit SAM3 Segmentation`, `Image Edit G'MIC Integration`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `t()` connect `Tagger/Prompt i18n Helpers` to `Models Tab Frontend`, `Style Catalog Tab`, `App Shell & i18n Init`, `Prompt Tab Frontend`, `AI Tool Tab Frontend`, `GenerateUI Feeder Tab`, `Gallery Tab Frontend & Toasts`, `Generate Tab Frontend & Modals`, `Image Prompt Tab`, `Nodes Tab Frontend`, `Metadata Tab Frontend`, `App Shell & i18n Init`, `Generate Tab Frontend & Modals`, `GenerateUI Lab Tab`, `ComfyUI Client & Editor`, `Workflow Tab Frontend & Storage`, `App Shell & i18n Init`, `GenerateUI Lab Tab`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `ImageEditTab` connect `Image Edit Layer & Draw Tools` to `Image Edit Background Removal`, `App Shell & i18n Init`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **What connects `META_NODE_TYPES`, `AI_BACKEND_DEFAULT_URLS`, `AI_LANG_NAMES` to the rest of the system?**
